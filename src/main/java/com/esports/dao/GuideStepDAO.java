...
public class GuideStepDAO {
    ...
    public List<GuideStep> getByGuideId(int guideId) {
        ...
        try {
            ...
            System.out.println("❌ getByGuideId error: " + e.getMessage());
        }
        return steps;
    }
    ...
    public void add(GuideStep s) {
        ...
        try {
            ...
            ps.executeUpdate();
            System.out.println("✅ GuideStep added!");
        } catch (SQLException e) {
    ...
    public void update(GuideStep s) {
        ...
        try {
            ...
            ps.setInt(6, s.getId());
            ps.executeUpdate();
            System.out.println("✅ GuideStep updated!");
        } catch (SQLException e) {
    ...
    public void delete(int id) {
        ...
        try {
            ...
            ps.setInt(1, id);
            ps.executeUpdate();
            System.out.println("✅ GuideStep deleted!");
        } catch (SQLException e) {
